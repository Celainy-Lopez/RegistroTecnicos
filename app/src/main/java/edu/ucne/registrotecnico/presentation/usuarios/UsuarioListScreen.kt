...
private fun UsuarioRow(
    ...
    Card(
        ...
        Column(
            ...
            Row {
                Text(text = "Usuario #: ", fontWeight = FontWeight.ExtraBold)
                Text(text = it.usuarioId.toString())
            }
            ...
            Row {
                Text(text = "Balance: ", fontWeight = FontWeight.ExtraBold)
                Text(decimalFormat.format(it.balance))
            }
        }
    }
    HorizontalDivider()
...
private fun Preview() {
    val usuarios = listOf(
        UsuarioDto(
            usuarioId = 1,
            nombre = "Wilmer Castillo",
            balance = 10000.0
        ),
        UsuarioDto(
            usuarioId = 2,
            nombre = "Jose del Orbe",
            balance = 10000.0
        )
    )
